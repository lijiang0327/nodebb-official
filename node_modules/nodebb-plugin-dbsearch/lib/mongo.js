	...
	db.search = function(key, data, limit, callback) {
		...
		if (contentArr.length) {
			...
			for(var item in contentArr) {
				var indition = {};
				indition.content = RegExp(contentArr[item], 'i');
				queryArr.push(indition);
			}
			// searchQuery.$or = queryArr;
			searchQuery.$and = queryArr;
			// searchQuery.content = RegExp(data.content);
		}
